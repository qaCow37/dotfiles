			...
			settings = [
				...
				}
				{
					...
					bookmarks = [
						...
						{
							name = "SatisfactoryRankOverall";
							url = "https://reddit.com/r/SatisfactoryGame/comments/1fekus9/alternate_recipe_ranking_10_optimizing_for";
						...
						{
							name = "FactoryGuessr";
							url = "https://lemmytech.de/factoryguessr/";
							tags = ["satisfactory" "guessr" "game"];
						}
					];
				}
				{
